...
async function addWelcome(jid, enabled, message) {
    try {
        ...
        data.welcome[jid] = {
            enabled: enabled,
            message: message || '╔═🛸 WELCOME ON BOARD  ═╗\n║ 🛸 User: {user}\n║ HORIZON : {group}\n╠═══════════════╣\n║ 📜 Message:\n║ {description}\n╚═══════════════╝',
            channelId: '12036361513685998@newsletter'
        };
...
async function addGoodbye(jid, enabled, message) {
    try {
        ...
        data.goodbye[jid] = {
            enabled: enabled,
            message: message || '╔═ ADIOS TRAVELLER 🪐═╗\n║🧑‍🚀 Traveller : {user}\n║ 🛸 Spacecraft : {group}\n╠═══════════════╣\n║ Dont get yourself stretched  by a blackhole🪐!\n╚═══════════════╝',
            channelId: '12036316513685998@newsletter'
        };
